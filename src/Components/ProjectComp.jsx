  ...
  return (
    <div className="max-w-[700px] mx-auto">
      <div className="pt-[30px]  font-nunito">
        ...
        <div className="my-5 grid gap-2 grid-cols-1 sm:grid-cols-2">
          <a
            ...
            className="rounded p-2 block text-center hover:bg-[#262626] flex items-center justify-center gap-3"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
          ...
          <a
            ...
            className={`rounded p-2 block text-center hover:bg-[#262626] flex items-center justify-center gap-3 ${
              obj.backendGH == "" ? "pointer-events-none bg-[] opacity-25" : ""
            }`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      <NavLink
        ...
        className="rounded p-2 block text-center hover:bg-[#262626]"
      >
        All projects
      </NavLink>
